...
pub type GenmcThreadIdInner = i32;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct GenmcThreadId(pub GenmcThreadIdInner);

pub const GENMC_MAIN_THREAD_ID: GenmcThreadId = GenmcThreadId(0); // TODO GENMC: is this guaranteed?

#[derive(Debug)]
pub struct ThreadInfo {
    pub miri_tid: ThreadId,
    pub genmc_tid: GenmcThreadId,
    // TODO GENMC: what is the correct name for this?
    pub user_code_finished: bool,
    // is_joined: bool, // TODO GENMC: is this useful?
}
